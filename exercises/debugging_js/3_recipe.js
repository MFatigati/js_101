...
let dishName = random(adjective).concat(random(firstNoun)).concat(random(secondNoun)); // need to use concat if you want to preserve the arrays
let dish = random(ingredients, 3) + random(spices, 2) + random(extras, 1);

console.log(typeof dishName) // string
