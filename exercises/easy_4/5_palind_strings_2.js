...
is a palindrome, or false otherwise. This time, however, your function should be 
...
function isRealPalindrome(str) {
  return str.toLowerCase().match(/\w/g).join("") === str.toLowerCase().match(/\w/g).reverse().join("");
}*/
